...
## v0.2.0 — Backward-Pass Correctness Sweep (2026-07-11)
...
- New finite-difference gradient-check test suites added under `tests/`
  (94 test functions total): `activation_gaps_gradient_test.rs` (32),
  `conv1d_gradient_test.rs` (8), `conv3d_gradient_test.rs` (8),
  `group_instance_norm_gradient_check.rs` (10),
  `normalization_gradient_check.rs` (14),
  `slice_concat_stack_split_gather_gradient_test.rs` (22).
